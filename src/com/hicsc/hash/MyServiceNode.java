...
public class MyServiceNode implements Node{
    ...
    public MyServiceNode(String ip, int port) {
        this.ip = ip;
        this.port = port;
    }
    ...
    public static void main(String[] args) {
        ...
        MyServiceNode node1 = new MyServiceNode("127.0.0.1",8080);
        MyServiceNode node2 = new MyServiceNode("127.0.0.1",8081);
        MyServiceNode node3 = new MyServiceNode("127.0.0.1",8082);
        MyServiceNode node4 = new MyServiceNode("127.0.0.1",8083);
        ...
        MyServiceNode node5 = new MyServiceNode("127.0.0.1",8080);//put new service online
    ...
    private static void goRoute(ConsistentHashRouter<MyServiceNode> consistentHashRouter ,String ... requestIps){
        for (String requestIp: requestIps) {
            System.out.println(requestIp + " is route to " + consistentHashRouter.route(requestIp));
        }
    }
}
